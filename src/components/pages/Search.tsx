    ...
    <div className='container mx-auto px-4 py-8'>
      <div className='max-w-2xl mx-auto'>
        ...
        <div className='space-y-4'>
          {results.map((actor) => (
            <div key={actor.did} className='p-4 bg-white dark:bg-gray-800 rounded-lg shadow'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400'>@{actor.handle}</p>
                </div>
              </div>
              {actor.description && (
                <p className='mt-2 text-sm text-gray-600 dark:text-gray-300'>{actor.description}</p>
              )}
            </div>
          ))}
        </div>
