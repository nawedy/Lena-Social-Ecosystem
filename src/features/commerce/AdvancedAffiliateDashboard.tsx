  ...
  if (loading || !analytics) {
    return (
      <View className='flex-1 justify-center items-center'>
        <Text className='text-lg dark:text-white'>Loading advanced analytics...</Text>
      </View>
    );
  }
  ...
  return (
    <ScrollView className='flex-1 bg-gray-100 dark:bg-gray-900'>
      ...
      <View className='bg-white dark:bg-gray-800 m-4 p-4 rounded-lg'>
        <Text className='text-lg font-semibold mb-4 dark:text-white'>Revenue Forecast</Text>
        <LineChart
          data={{
            ...
            datasets: [
              {
                data: analytics.revenue.forecast.slice(-7).map((day) => day.predicted),
              },
            ],
          }}
      ...
      <View className='bg-white dark:bg-gray-800 m-4 p-4 rounded-lg'>
        <Text className='text-lg font-semibold mb-4 dark:text-white'>Audience Demographics</Text>
        <PieChart
          data={Object.entries(analytics.audience.demographics).map(([key, value]) => ({
            name: key,
            population: value,
      ...
      {/* Content Performance */}
      <View className='bg-white dark:bg-gray-800 m-4 p-4 rounded-lg'>
        <Text className='text-lg font-semibold mb-4 dark:text-white'>Content Performance</Text>
        {analytics.content.topPerforming.slice(0, 5).map((content) => (
          <View key={content.uri} className='mb-4 border-b border-gray-200 pb-4'>
      ...
      {/* Trending Topics */}
      <View className='bg-white dark:bg-gray-800 m-4 p-4 rounded-lg'>
        <Text className='text-lg font-semibold mb-4 dark:text-white'>Trending Topics</Text>
      ...
      {/* Best Posting Times */}
      <View className='bg-white dark:bg-gray-800 m-4 p-4 rounded-lg'>
        <Text className='text-lg font-semibold mb-4 dark:text-white'>Best Posting Times</Text>
      ...
      <View className='flex-row flex-wrap p-4'>
        ...
        >
          <View className='bg-blue-500 rounded-lg p-4'>
            <Text className='text-white font-semibold'>Predict Performance</Text>
          </View>
        </TouchableOpacity>
      </View>
    </ScrollView>
