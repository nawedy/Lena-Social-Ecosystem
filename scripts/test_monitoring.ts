...
setInterval(() => {
  ...
  const features = ['create_post', 'upload_video', 'share_content', 'edit_profile'];
...
const password = process.env.PROMETHEUS_PASSWORD || 'Xy7+dQ9K2N5vM4pR8sT3wU6hJ1mB4nL9kF3qE5zW';
